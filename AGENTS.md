...
For serious audits, use `/home/dinesh/.codex/knowledge/smart-contract-audit/workflows/mythos-inspired-audit-workflow.md` as the local multi-pass audit workflow and `/home/dinesh/.codex/knowledge/smart-contract-audit/workflows/arsen-critical-flow-audit-workflow.md` as its critical-flow prioritization companion. Apply the Arsen workflow after program lock and initial mapping to identify money-carrying and security-critical paths, build focused attacker lenses, and perform a protocol-specific deep pass. It prioritizes depth but never authorizes skipping the mandatory first-pass reading of every in-scope file. Use `/home/dinesh/.codex/knowledge/smart-contract-audit/templates/audit-coverage-ledger.md` for file coverage, `/home/dinesh/.codex/knowledge/smart-contract-audit/templates/candidate-verification-card.md` for candidate verification, and `/home/dinesh/.codex/knowledge/smart-contract-audit/templates/audit-gate-receipt.md` as the visible proof that program rules, skills, knowledge sweeps, universal invariants, concrete checks, and remaining uncertainty were handled before any conclusion.
