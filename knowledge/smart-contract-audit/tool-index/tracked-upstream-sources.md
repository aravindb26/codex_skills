...
| Crypto Training Hacks | <https://crypto.training/hacks/> | Import compact deduped exploit-pattern stubs with the local importer; keep full walkthroughs as source links only. |
