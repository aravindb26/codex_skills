---
name: report-writing
description: Bug bounty report writing for Web2/AppSec platforms such as H1, Bugcrowd, and Intigriti — report templates, human tone guidelines, impact-first writing, CVSS 3.1 scoring, title formula, impact statement formula, severity decision guide, downgrade counters, pre-submit checklist. Use after validating a finding and before submitting. Never use "could potentially" — prove it or don't report.
---
...
## WEB3 REPORTS OMITTED IN THIS LOCAL COPY

This local reference install is intentionally Web2/AppSec focused. For Web3 or smart-contract reports, use the active smart-contract audit skills and knowledge base instead:
