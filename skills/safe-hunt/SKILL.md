...
- Run: `python3 /home/dinesh/.codex/skills/safe-hunt/scripts/sweep.py [--protocol <name>] [--address <0x>] [--network <net>] [--output report.md]`
...
```bash
# Audit one Safe
python3 /home/dinesh/.codex/skills/safe-hunt/scripts/sweep.py --address 0xABC... --network ethereum

# Audit a protocol by name (DeFiLlama lookup)
python3 /home/dinesh/.codex/skills/safe-hunt/scripts/sweep.py --protocol "Lido"

# Full DeFiLlama sweep (slow - ~292 protocols)
python3 /home/dinesh/.codex/skills/safe-hunt/scripts/sweep.py --sweep --output sweep_report.md

# Sweep with network filter
python3 /home/dinesh/.codex/skills/safe-hunt/scripts/sweep.py --sweep --network ethereum --top 20
```
